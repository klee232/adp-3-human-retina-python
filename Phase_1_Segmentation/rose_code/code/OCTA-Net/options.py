...
# data settings
parser.add_argument("--data_dir", type=str, default="C:/Users/klee232/Desktop/Thesis/personal-GitHub/adp-3-human-retina-python/Phase_1_Segmentation/rose_dataset/ROSE-1/SVC", help="path to folder for getting dataset")
