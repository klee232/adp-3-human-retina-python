...
def partition_rose_2_dataset(train_ROSE2_org, 
    ...
    num_files = converted_train_ROSE2_org.shape[2]
    k = 4.0
    ratio = 1 / k
    ...
    num_row = converted_train_ROSE2_org.shape[0]
    num_col = converted_train_ROSE2_org.shape[1]
    fold_valid_ROSE2_org = np.zeros((num_row, num_col, num_valid_files, int(k)))
    fold_valid_ROSE2_orgGt = np.zeros((num_row, num_col, num_valid_files, int(k)))
    fold_train_ROSE2_org = np.zeros((num_row, num_col, num_train_files, int(k)))
    fold_train_ROSE2_orgGt = np.zeros((num_row, num_col, num_train_files, int(k)))
    start_valid_ind = 0
