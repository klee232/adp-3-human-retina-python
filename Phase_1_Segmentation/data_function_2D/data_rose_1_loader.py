...
# SVC dataset:
# train_ROSE_SVC_org: Training image for SVC (np array: [x,y,num_image])
# train_ROSE_SVC_orgGt: Ground truth for training image for SVC (np array: [x,y,num_image])
# train_ROSE_SVC_thinGt: Thin vessel Ground truth for training image for SVC (np array: [x,y,num_image])
# train_ROSE_SVC_thickGt: Thick vessel Ground truth for training image for SVC (np array: [x,y,num_image])
# test_ROSE_SVC_org: Testing image for SVC (np array: [x,y,num_image])
# test_ROSE_SVC_orgGt: Testing Ground Truth image for SVC (np array: [x,y,num_image])
# test_ROSE_SVC_thinGt: Thin vessel Ground Truth image for SVC (np array: [x,y,num_image])
# test_ROSE_SVC_thickGt: Thick vessel Ground Truth image for SVC (np array: [x,y,num_image])
#
# DVC dataset:
# train_ROSE_DVC_org: Training image for DVC (np array: [x,y,num_image])
# train_ROSE_DVC_orgGt: Ground truth for training image for DVC (np array: [x,y,num_image])
# test_ROSE_DVC_org: Testing image for DVC (np array: [x,y,num_image])
# test_ROSE_DVC_orgGt: Testing Ground Truth image for DVC (np array: [x,y,num_image])
#
# SVC_DVC dataset:
# train_ROSE_SDVC_org: Training image for SDVC (np array: [x,y,num_image])
# train_ROSE_SDVC_orgGt: Ground truth for training image for SDVC (np array: [x,y,num_image])
# test_ROSE_SDVC_org: Testing image for SDVC (np array: [x,y,num_image])
# test_ROSE_SDVC_orgGt: Testing Ground Truth image for SDVC (np array: [x,y,num_image])
