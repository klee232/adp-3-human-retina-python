...
def partition_rose_O_dataset(train_ROSEO_SVC_org, 
    ...
    num_files = converted_train_ROSEO_SVC_org.shape[2]
    k = 4.0
    ratio = 1 / k
    ...
    num_row = converted_train_ROSEO_SVC_org.shape[0]
    num_col = converted_train_ROSEO_SVC_org.shape[1]
    fold_valid_ROSEO_SVC_org = np.zeros((num_row, num_col, num_valid_files, int(k)))
    fold_valid_ROSEO_DVC_org = np.zeros((num_row, num_col, num_valid_files, int(k)))
    fold_valid_ROSEO_IVC_org = np.zeros((num_row, num_col, num_valid_files, int(k)))
    fold_valid_ROSEO_FAZ_gt = np.zeros((num_row, num_col, num_valid_files, int(k)))
    fold_valid_ROSEO_junct_gt = np.zeros((num_row, num_col, num_valid_files, int(k)))
    fold_valid_ROSEO_vessel_gt = np.zeros((num_row, num_col, num_valid_files, int(k))) 
    fold_train_ROSEO_SVC_org = np.zeros((num_row, num_col, num_train_files, int(k)))
    fold_train_ROSEO_DVC_org = np.zeros((num_row, num_col, num_train_files, int(k)))
    fold_train_ROSEO_IVC_org = np.zeros((num_row, num_col, num_train_files, int(k)))
    fold_train_ROSEO_FAZ_gt = np.zeros((num_row, num_col, num_train_files, int(k)))
    fold_train_ROSEO_junct_gt = np.zeros((num_row, num_col, num_train_files, int(k)))
    fold_train_ROSEO_vessel_gt = np.zeros((num_row, num_col, num_train_files, int(k)))
    start_valid_ind = 0
