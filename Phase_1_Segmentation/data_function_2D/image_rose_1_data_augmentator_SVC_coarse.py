...
def img_rotator_ROSE_SVC_coarse(num_aug, angles, image, thickgroundtruth, thingroundtruth):
    ...
    return out_img, out_thickGt, out_thinGt
...
# out_img: processed image array (np array: [x,y,num_image])
# out_gt: processed groundtruth array (np array: [x,y,num_image])
def img_flipper_ROSE_SVC_coarse(image, thickgroundtruth, thingroundtruth):
    import cv2 # for image rotation, image flipping
...
# out_img: processed image array (np array: [x,y,num_image])
# out_gt: processed groundtruth array (np array: [x,y,num_image])
def img_elastic_deformer_ROSE_SVC_coarse(image, thickgroundtruth, thingroundtruth):
...
# out_img: processed image array (np array: [x,y,num_image])   
# out_gt: processed groundtruth array (np array: [x,y,num_image])
def img_contrast_jitter_ROSE_SVC_coarse(image, thickgroundtruth, thingroundtruth):
