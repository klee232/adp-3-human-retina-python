...
# train_ROSEO_SVC_org: Training image for SVC layer (np array: [x,y,num_image])
# test_ROSEO_SVC_org: Testing image for SVC layer (np array: [x,y,num_image])
# train_ROSEO_DVC_org: Training image for DVC layer (np array: [x,y,num_image])
# test_ROSEO_DVC_org: Testing image for DVC layer (np array: [x,y,num_image])
# train_ROSEO_IVC_org: Training image for IVC layer (np array: [x,y,num_image])
# test_ROSEO_IVC_org: Testing image for IVC layer (np array: [x,y,num_image])
# train_ROSEO_FAZ_gt: Groundtruth image for FAZ zone (np array: [x,y,num_image])
# test_ROSEO_FAZ_gt: Groundtruth image for FAZ zone (np array: [x,y,num_image])
# train_ROSEO_junct_gt: Groundtruth image for junction node location of vessels (np array: [x,y,num_image])
# test_ROSEO_junct_gt: Groundtruth image for junction node location of vessels (np array: [x,y,num_image])
# train_ROSEO_vessel_gt: Groundtruth image for vessel segmentation (np array: [x,y,num_image])
# test_ROSEO_vessel_gt: Groundtruth image for vessel segmentation (np array: [x,y,num_image])
...
def load_rose_O_dataset(base_dir=None):
    ...
    train_ROSEO_FAZ_gt = np.stack(train_FAZ_gt, axis=-1)
    ...
    test_ROSEO_FAZ_gt = np.stack(test_FAZ_gt, axis=-1)
    ...
    train_ROSEO_junct_gt = np.stack(train_junct_gt, axis=-1)
    ...
    test_ROSEO_junct_gt = np.stack(test_junct_gt, axis=-1)
    ...
    train_ROSEO_vessel_gt = np.stack(train_vessel_gt, axis=-1)
    ...
    test_ROSEO_vessel_gt = np.stack(test_vessel_gt, axis=-1)
